class Splash {
 ...
 constructor() {
  ...
  this.title = createDiv("Taiko no Tatsujin太鼓达人");
  ...
  this.name = createDiv("Shuxiang Liu");
  this.name.position(this.splashBorder+20, this.splashBorder+60);
  
  this.info = createDiv("This is a taiko drummer game simulated through P5js, hope you have fun!. <p> Don Ka, Don Don Ka! <p> <a href=https://editor.p5js.org/sliu62494/sketches/Lug7pr9rd>view code</a>");
